...
public class News_Japanese extends AppCompatActivity {
    ...
    private static final String TAG = News_Japanese.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_news__japanese);
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),News_Menu_Japanese.class);
                startActivity(intent);
        ...
        initialize();
        Recycler_Japanese adapter=new Recycler_Japanese(News_Japanese.this,datanews);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //dialog.hide();
                        Toast.makeText(News_Japanese.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
...
//Adding the string request to the queue
    ...
    public void parseResult(JSONObject arabiNews) {
        ...
        try {
            ...
            Recycler_Japanese adapter=new Recycler_Japanese(getApplicationContext(),datanews);
            recyclerView_news.setAdapter(adapter);
    ...
    public void onBackPressed() {
        Intent home=new Intent(News_Japanese.this,News_Select_Language.class);
