...
public class News_Spanish extends AppCompatActivity {
    ...
    private static final String TAG = News_Spanish.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_news__spanish);
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),News_Menu_Spanish.class);
                startActivity(intent);
        ...
        initialize();
        Recycler_News adapter=new Recycler_News(News_Spanish.this,datanews);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //dialog.hide();
                        Toast.makeText(News_Spanish.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
...
//Adding the string request to the queue
    ...
    public void onBackPressed() {
        Intent home=new Intent(News_Spanish.this,News_Select_Language.class);
