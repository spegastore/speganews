...
public class News_FromHebrew extends AppCompatActivity {
    ...
    private static final String TAG = News_FromHebrew.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_news__from_hebrew);
        getSupportActionBar().hide();
        chooseicon = (ImageView)findViewById(R.id.new_right_menu);
        chooseicon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(News_FromHebrew.this,News_Choose_Language.class);
                startActivity(intent);

            }
        });
        heading=(TextView)findViewById(R.id.textView_heading_hebrew);
        bar=(ProgressBar)findViewById(R.id.progressBar);
        icon = (ImageView) findViewById(R.id.imageView_icon);
        icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(News_FromHebrew.this,News_Menu_Hebrew.class);
                startActivity(intent);
        ...
        initialize();
        Recycler_News adapter=new Recycler_News(News_FromHebrew.this,datanews);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //dialog.hide();
                        Toast.makeText(News_FromHebrew.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
...
//Adding the string request to the queue
    ...
    public void onBackPressed() {
        Intent home=new Intent(News_FromHebrew.this,News_Select_Language.class);
