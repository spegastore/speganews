...
public class News_Desc_Japanese extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news__desc__japanese);
        ...
        Picasso.with(this).load("http://speganews.com"+image).error(R.drawable.error_message).placeholder(R.drawable.loading).into(img);
