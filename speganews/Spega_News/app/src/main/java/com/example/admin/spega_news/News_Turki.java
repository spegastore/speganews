...
public class News_Turki extends AppCompatActivity {
    ...
    private static final String TAG = News_Turki.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_news__turki);
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),News_Menu_Turki.class);
                startActivity(intent);
        ...
        initialize();
        Recycler_News adapter=new Recycler_News(News_Turki.this,datanews);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //dialog.hide();
                        Toast.makeText(News_Turki.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
...
//Adding the string request to the queue
    ...
    public void onBackPressed() {
        Intent home=new Intent(News_Turki.this,News_Select_Language.class);
