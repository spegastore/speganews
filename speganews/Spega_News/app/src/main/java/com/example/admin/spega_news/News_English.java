...
public class News_English extends AppCompatActivity {
    ...
    private static final String TAG = News_English.class.getSimpleName();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_news__english);
        getSupportActionBar().hide();
        chooseicon = (ImageView)findViewById(R.id.new_right_menu);
        chooseicon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(News_English.this,News_Choose_Language.class);
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(News_English.this,News_Menu_English.class);
                startActivity(intent);
        ...
        LinearLayoutManager llm = new LinearLayoutManager(News_English.this);
        recyclerView_news.setLayoutManager(llm);
        recyclerView_news.setHasFixedSize(true);
        initialize();
        Recycler_News adapter=new Recycler_News(News_English.this,datanews);
        recyclerView_news.setAdapter(adapter);
        newsFeed();
    }
    private void newsFeed() {

        String url ="http://speganews.com/api/english_sepcat.php?id=1&off=0";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //dialog.hide();
                        Toast.makeText(News_English.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
...
//Adding the string request to the queue
    ...
    public void onBackPressed() {
        Intent home=new Intent(News_English.this,News_Select_Language.class);
