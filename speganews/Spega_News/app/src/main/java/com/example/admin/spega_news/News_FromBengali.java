...
public class News_FromBengali extends AppCompatActivity {
    ...
    private static final String TAG = News_FromBengali.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_news__from_bengali);
        getSupportActionBar().hide();
        chooseicon = (ImageView)findViewById(R.id.new_right_menu);
        chooseicon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(News_FromBengali.this,News_Choose_Language.class);
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(News_FromBengali.this,News_Menu_Bengali.class);
                startActivity(intent);
        ...
        initialize();
        Recycler_News adapter=new Recycler_News(News_FromBengali.this,datanews);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //dialog.hide();
                        Toast.makeText(News_FromBengali.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
...
//Adding the string request to the queue
    ...
    public void onBackPressed() {
        Intent home=new Intent(News_FromBengali.this,News_Select_Language.class);
